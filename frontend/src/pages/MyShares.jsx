...
export default function MyShares() {
  ...
  const disableShare = async (conversationId, shareId) => {
    try {
      ...
      setShares((previous) => previous.filter((share) => share.share_id !== shareId));
    } catch {
      // Leave current UI state unchanged if the request fails.
    }
  };
  ...
  return (
    <Layout>
      <div className="h-full bg-gray-950 text-white p-8 overflow-y-auto">
        <div className="max-w-3xl mx-auto">
          ...
          {!loading && shares.length === 0 && (
            <div className="text-center py-20 text-gray-600">
              <div className="text-5xl mb-4">Share</div>
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      >
                        {copied === share.share_id ? "Copied" : "Copy"}
                      </button>
                      ...
                      <a
                        ...
                        className="text-xs px-3 py-1.5 bg-gray-800 hover:bg-gray-700 text-gray-300 rounded-lg transition-all"
                      >
                        View
                      </a>
                      ...
                      <button
                        ...
                        className="text-xs px-3 py-1.5 bg-red-900/40 hover:bg-red-900/70 text-red-400 hover:text-red-300 border border-red-800/50 rounded-lg transition-all"
                      >
                        Disable
                      </button>
                    </div>
